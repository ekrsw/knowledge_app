...
function ToastItem({ toast, onRemove }: { toast: Toast; onRemove: (id: string) => void }) {
  const baseStyles = 'rounded-lg border p-4 flex items-start space-x-3 shadow-lg backdrop-blur-sm min-w-[320px] max-w-md animate-slide-in-right';
  ...
  return (
    <div className={cn(baseStyles, variants[toast.type])}>
      {icons[toast.type]}
      ...
      {toast.dismissible !== false && (
        <button
          ...
          className="text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-900 focus:ring-blue-500 rounded ml-2"
